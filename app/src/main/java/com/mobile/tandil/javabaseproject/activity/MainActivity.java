...
public class MainActivity extends AppCompatActivity implements ListenerDialogFragment {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter = new ParkingPresenter(new ParkingModel(ReservationDatabase.getInstance()), new ParkingView(this, binding));
        setListener();
    }

    public void setListener() {
        binding.setParkingButton.setOnClickListener(view -> presenter.showFragment(this));
        binding.reserveParkingButton.setOnClickListener(view -> presenter.showReserverActivity());
    }
